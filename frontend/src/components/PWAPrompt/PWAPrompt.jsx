  ...
  return (
    <div className="pwa-prompt">
      ...
      <div className="pwa-prompt-content">
        ...
        {isIOS ? (
          <div className="pwa-prompt-desc">Tap <strong>Share</strong> → <strong>Add to Home Screen</strong> for the full app experience.</div>
        ) : (
          <div className="pwa-prompt-desc">Install devFit as an app for faster access and offline features.</div>
        )}
      </div>
      {!isIOS && (
